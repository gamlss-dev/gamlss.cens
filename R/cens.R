#-------------------------------------------------------------------------------
#source('/Users/stasinom/Dropbox/gamlss/library/gamlss.cens/R/gen.cens.R', chdir = TRUE)
#source('/Users/stasinom/Dropbox/gamlss/library/gamlss.cens/R/cens.d.R', chdir = TRUE)
#source('/Users/stasinom/Dropbox/gamlss/library/gamlss.cens/R/cens.p.R', chdir = TRUE)
cens <- function (
              family = "NO", 
